...
# Reading files
# =============================================================================
df = pd.read_csv('../Data/UberWeekdayProcessedv4.csv')
...
print("According to Beta Distribution, we have that the probability of an uber journey being less than 26mins is " + str(round(probability*100,2)) + "%\n")
...
plt.title('Weekday Uber Rides Crossing City of London')
plt.xticks(np.arange(min(ind), max(ind)+1, 1.0), labels, rotation=90)
plt.legend(loc='best')
plt.show()

print("Central vs Not Central")
...
plt.title('Time Series of Weekday Uber Rides', fontsize=18)
